<?php
/**
 * 域名编码转换 - Http_IDNA::decode('转码域名转换为中文域名') / Http_IDNA::encode('中文域名转码');
 *
 * @update Kee <keezhao@xmisp.com> 2015-12-29
 * */
// {{{ license
...
class Domain_IDNA {
    ...
    public function __construct($options = array('idn_version' => 2008))
    {
     ...
     */
    public function idna_decode($input, $one_time_encoding = false)
    {
        // Optionally set
		 ...
		 * Static to Decode
		 * */
		static public function decode ($input, $one_time_encoding = false) {
			$instance = new self();
			return $instance->idna_decode($input, $one_time_encoding);
		}
     ...
     */
    public function idna_encode($decoded, $one_time_encoding = false)
    {
		 ...
		 * Static to Encode
		 * */
		static public function encode ($decoded, $one_time_encoding = false) {
			$instance = new self();
			return $instance->idna_encode($decoded, $one_time_encoding);
		}
